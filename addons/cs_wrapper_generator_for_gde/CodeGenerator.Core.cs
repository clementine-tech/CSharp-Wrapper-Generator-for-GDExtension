...
internal static partial class CodeGenerator {
	...
	private static void BuildupMethodArguments(
		...
		for (var i = 0; i < propertyInfos.Length; i++) {
			...
			string argumentTypeName = typeKind switch {
				CodeGenerator.GdType.BuiltIn
				 or CodeGenerator.GdType.GdEnum
				 or CodeGenerator.GdType.EnumConstants
				 or CodeGenerator.GdType.GdObject
				 or CodeGenerator.GdType.GdVariant
				 or CodeGenerator.GdType.TypedArray
				 or CodeGenerator.GdType.VariantArray
